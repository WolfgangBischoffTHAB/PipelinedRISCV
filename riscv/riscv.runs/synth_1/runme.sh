...
HD_PWD='C:/dev/fpga/PipelinedRISCV/riscv/riscv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_testbench.tcl
